...
Don't modify this file manually. (Generated: 2021-01-14 22:23:26.330361)
"""
...
def dp_sgd(data, theta, learning_rate, noise_scale, group_size, gradient_norm_bound, max_iters, clipping_value, sample_size, param_search_step_size, param_search_max_iters, public_data=None, data_2=None, **kwargs):
    """
    DPSGD Component
    
    Tune theta to optimize the logistic function on the data.
    
    :param data: Private data to optimize over.
    :param public_data: Private data to optimize over.
    :param data_2: Private data to optimize over.
    :param theta: Initial weight parameters.
    :param learning_rate: Multiplier on the magnitude of each noised gradient.
    :param noise_scale: TODO: remove this, compute based on sensitivity (gradient norm bound, clipping value, sample sizes etc)
    :param group_size: 
    :param gradient_norm_bound: 
    :param max_iters: 
    :param clipping_value: 
    :param sample_size: 
    :param param_search_step_size: 
    :param param_search_max_iters: 
    :param kwargs: data bounds of the form [argument]_[bound]=[lower | upper | categories | ...]
    :return: Optimized theta parameters.
    """
    return Component(
        "DPSGD",
        arguments={
            'data': Component.of(data),
            'public_data': Component.of(public_data),
            'data_2': Component.of(data_2),
            'theta': Component.of(theta)
        },
        options={
            ...
            'param_search_step_size': param_search_step_size,
            'param_search_max_iters': param_search_max_iters
        },
        constraints=kwargs)
