...
_GAUSSIANMECHANISM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='analytic', full_name='whitenoise.GaussianMechanism.analytic', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SNAPPINGMECHANISM = _descriptor.Descriptor(
  ...
  full_name='whitenoise.SnappingMechanism',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='privacy_usage', full_name='whitenoise.SnappingMechanism.privacy_usage', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SnappingMechanism = _reflection.GeneratedProtocolMessageType('SnappingMechanism', (_message.Message,), {
  ...
  '__module__' : 'components_pb2'
  # @@protoc_insertion_point(class_scope:whitenoise.SnappingMechanism)
  })
